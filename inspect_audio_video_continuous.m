...
involvedValue = get_bats_involved(call_info,call_k,params,'facingCaller');

uicontrol(vocalizationPanel,'unit','normalized','style','listbox','string',...
        [{''} params.bat_IDs],'position',[0.01 0.3 0.9 0.175],'value',involvedValue,...
        'Min',0,'Max',length(params.bat_IDs),'callback',{@updateCallInfoCallback,params,call_k},...
        'Tag','facingCaller');
...
uicontrol(vocalizationPanel,'unit','normalized','style','listbox','string',...
        [{''} params.bat_IDs],'position',[0.01 0.05 0.9 0.175],'value',instigatorValue,...
        'Min',0,'Max',length(params.bat_IDs),'callback',{@updateCallInfoCallback,params,call_k},...
        'Tag','notFacingCaller');
